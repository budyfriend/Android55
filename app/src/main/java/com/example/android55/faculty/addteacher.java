...
import com.example.android55.NoticeData;
import com.example.android55.R;
import com.example.android55.UploadImage;
import com.example.android55.UploadNotice;
...
public class addteacher extends AppCompatActivity {
    ...
    private EditText teachername, addteacheremail, teacherpost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(addteacher.this);
        ...
        String[] items = new String[]{"Select Category", "MCA", "MBA", "CSE", "ESE"};
        ...
        addteacherbtn.setOnClickListener(new View.OnClickListener() {
            ...
            private void insertData() {
                ...
                TeacherData teacherData = new TeacherData(name, email, downloadUrl, post, uniquekey);
